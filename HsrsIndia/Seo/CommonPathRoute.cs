            ...
            if (data != null)
            {
                ...
                switch (path)
                {
                    ...
                    case "sitemap":
                        ...
                        break;
                    default:
                        httpContext.Response.Redirect("http://www.hsrsglobal.com.au/in");
                        break;
                }
